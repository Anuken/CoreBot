...
public class Messages extends ListenerAdapter{
    ...
    private static final Pattern badWordPattern = Pattern.compile(new String(Base64Coder.decode("KD88IVthLXpBLVpdKSg/OmN1bXxzZW1lbnxwb3JufGNvY2t8cHVzc3l8Y3VudHxuaWdnLnIpKD8hW2EtekEtWl0p")));
